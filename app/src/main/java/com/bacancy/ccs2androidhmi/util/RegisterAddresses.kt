...
object RegisterAddresses {
    const val CHARGER_ACTIVE_DEACTIVE = 442
    const val PIN_AUTHORIZATION = 75
    ...
    const val GUN1_VOLTAGE = 354
    const val GUN1_CURRENT = 355
    const val GUN1_OUTPUT_ON_OFF = 356
